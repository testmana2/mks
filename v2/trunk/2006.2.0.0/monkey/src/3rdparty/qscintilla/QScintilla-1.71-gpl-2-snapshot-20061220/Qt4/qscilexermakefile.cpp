...
QColor QsciLexerMakefile::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerMakefile::eolFill(int style) const
{
    return (style == Error);
}
...
QFont QsciLexerMakefile::font(int style) const
{
    QFont f;
...
QColor QsciLexerMakefile::paper(int style) const
{
    if (style == Error)
