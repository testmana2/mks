...
QColor QsciLexerLua::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerLua::eolFill(int style) const
{
...
QFont QsciLexerLua::font(int style) const
{
    QFont f;
...
QColor QsciLexerLua::paper(int style) const
{
    switch (style)
    {
    case Comment:
