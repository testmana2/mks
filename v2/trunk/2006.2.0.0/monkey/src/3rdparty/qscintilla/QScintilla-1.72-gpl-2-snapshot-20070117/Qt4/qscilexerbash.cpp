...
QColor QsciLexerBash::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerBash::eolFill(int style) const
{
    switch (style)
    {
    case SingleQuotedHereDocument:
...
QFont QsciLexerBash::font(int style) const
{
    QFont f;
...
QColor QsciLexerBash::paper(int style) const
{
    switch (style)
    {
    case Error:
