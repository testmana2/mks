...
QColor QsciLexerPOV::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerPOV::eolFill(int style) const
{
...
QFont QsciLexerPOV::font(int style) const
{
    QFont f;
...
QColor QsciLexerPOV::paper(int style) const
{
    switch (style)
    {
    case UnclosedString:
