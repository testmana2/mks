...
public:
    ...
    //!
    //! \sa setDocument()
    QsciDocument document() {return doc;}
...
private:
    ...
    QString convertTextS2Q(const char *s);
    const char *convertTextQ2S(const QString &q, int *len = 0);
    ...
    QStringList wordsForAutoCompletion();
    bool getSeparator(int &pos);
    QString getWord(int &pos);
