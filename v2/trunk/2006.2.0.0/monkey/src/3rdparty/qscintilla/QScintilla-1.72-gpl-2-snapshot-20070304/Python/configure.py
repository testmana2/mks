...
def check_qscintilla():
    ...
    if os.access(sciglobal, os.F_OK):
        ...
        sipconfig.inform("Qsci/qsciglobal.h could not be found in %s. If QScintilla is installed then use the -n argument to explicitly specify the correct directory." % opt_qsciincdir)
...
def generate_code():
    ...
    installs.append(("QScintilla2.api", os.path.join(qt_data_dir, "qsci", "api", "python")))
...
def main(argv):
    ...
    global qsci_define, qt_data_dir
