...
QColor QsciLexerCSharp::color(int style) const
{
...
bool QsciLexerCSharp::eolFill(int style) const
{
    if (style == VerbatimString)
        return true;
...
QFont QsciLexerCSharp::font(int style) const
{
    if (style == VerbatimString)
#if defined(Q_OS_WIN)
...
QColor QsciLexerCSharp::paper(int style) const
{
    if (style == VerbatimString)
