...
QColor QsciLexerPython::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerPython::eolFill(int style) const
{
...
QFont QsciLexerPython::font(int style) const
{
    QFont f;
...
QColor QsciLexerPython::paper(int style) const
{
