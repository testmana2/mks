...
QColor QsciLexerRuby::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerRuby::eolFill(int style) const
{
    bool fill;
...
QFont QsciLexerRuby::font(int style) const
{
    QFont f;
...
QColor QsciLexerRuby::paper(int style) const
{
    switch (style)
    {
    case Error:
