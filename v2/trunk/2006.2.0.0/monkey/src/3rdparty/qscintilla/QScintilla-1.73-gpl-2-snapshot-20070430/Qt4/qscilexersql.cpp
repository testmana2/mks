...
QColor QsciLexerSQL::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerSQL::eolFill(int style) const
{
...
QFont QsciLexerSQL::font(int style) const
{
    QFont f;
...
QColor QsciLexerSQL::paper(int style) const
{
    if (style == PlusPrompt)
