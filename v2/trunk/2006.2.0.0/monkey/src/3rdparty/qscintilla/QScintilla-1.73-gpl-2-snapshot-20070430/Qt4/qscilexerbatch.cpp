...
QColor QsciLexerBatch::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerBatch::eolFill(int style) const
{
    return (style == Label);
}
...
QFont QsciLexerBatch::font(int style) const
{
    QFont f;
...
QColor QsciLexerBatch::paper(int style) const
{
    switch (style)
    {
    case Label:
