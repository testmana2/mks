...
QColor QsciLexerVHDL::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerVHDL::eolFill(int style) const
{
...
QFont QsciLexerVHDL::font(int style) const
{
    QFont f;
...
QColor QsciLexerVHDL::paper(int style) const
{
    switch (style)
    {
    case UnclosedString:
