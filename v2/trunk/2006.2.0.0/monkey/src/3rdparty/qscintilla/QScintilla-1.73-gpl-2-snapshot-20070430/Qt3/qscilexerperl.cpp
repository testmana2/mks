...
QColor QsciLexerPerl::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerPerl::eolFill(int style) const
{
    switch (style)
    {
    case POD:
...
QFont QsciLexerPerl::font(int style) const
{
    QFont f;
...
QColor QsciLexerPerl::paper(int style) const
{
    switch (style)
    {
    case Error:
