...
QColor QsciLexerCPP::color(int style) const
{
    switch (style)
    {
    case Default:
...
bool QsciLexerCPP::eolFill(int style) const
{
...
QFont QsciLexerCPP::font(int style) const
{
    QFont f;
...
QColor QsciLexerCPP::paper(int style) const
{
