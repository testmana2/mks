...
QColor QsciLexerJavaScript::color(int style) const
{
    if (style == Regex)
...
bool QsciLexerJavaScript::eolFill(int style) const
{
    if (style == Regex)
        return true;
...
QFont QsciLexerJavaScript::font(int style) const
{
    if (style == Regex)
#if defined(Q_OS_WIN)
...
QColor QsciLexerJavaScript::paper(int style) const
{
    if (style == Regex)
