	...
	: QDockWidget( w ), mShown( false )
{
	...
	// connections
	connect( lwBuildSteps, SIGNAL( currentItemChanged ( QListWidgetItem *, QListWidgetItem *)), 
			this, SLOT( lwBuildSteps_currentItemChanged( QListWidgetItem *, QListWidgetItem * ) ) );
