...
void UIMain::initMenuBar()
{
	...
	pMenuBar* mb = menuBar();
	kernelActionsContainer* kac = kernelActionsContainer::instance();
	mb->menu( "mFile", tr( "&File" ) );
	mb->beginGroup( "mFile" );
		kac->kernelActions.aFileNew = mb->action( "aNew", tr( "&New..." ), QIcon( ":/file/icons/file/new.png" ), tr( "Ctrl+N" ), tr( "Create a new file" ) );
		kac->kernelActions.aFileOpen = mb->action( "aOpen", tr( "&Open..." ), QIcon( ":/file/icons/file/open.png" ), tr( "Ctrl+O" ), tr( "Open a file" ) );
		mb->menu( "mRecents", tr( "&Recents" ), QIcon( ":/file/icons/file/recents.png" ) );
		kac->kernelActions.aFileRecentsClear = mb->action( "mRecents/aClear", tr( "&Clear" ), QIcon( ":/file/icons/file/clear.png" ), QString::null, tr( "Clear the recents files list" ) );
		mb->action( "mRecents/aSeparator1" );
		mb->action( "aSeparator1" );
		mb->menu( "mSession", tr( "Session" ), QIcon( ":/file/icons/file/session.png" ) );
		kac->kernelActions.aFileSessionSave = mb->action( "mSession/aSave", tr( "Save" ), QIcon( ":/file/icons/file/save.png" ), QString::null, tr( "Save the current session files list" ) );
		kac->kernelActions.aFileSessionRestore = mb->action( "mSession/aRestore", tr( "Restore" ), QIcon( ":/file/icons/file/restore.png" ), QString::null, tr( "Restore the current session files list" ) );
		mb->action( "aSeparator2" );
		mb->menu( "mSave", tr( "&Save" ), QIcon( ":/file/icons/file/save.png" ) );
		(kac->kernelActions.aFileSaveCurrent = mb->action( "mSave/aCurrent", tr( "&Current" ), QIcon( ":/file/icons/file/save.png" ), tr( "Ctrl+S" ), tr( "Save the current file" ) ))->setEnabled (false);
		(kac->kernelActions.aFileSaveAll = mb->action( "mSave/aAll", tr( "&All" ), QIcon( ":/file/icons/file/saveall.png" ), QString::null, tr( "Save all files" ) ))->setEnabled( false );
		mb->menu( "mClose", tr( "&Close" ), QIcon( ":/file/icons/file/close.png" ) );
		(kac->kernelActions.aFileCloseCurrent = mb->action( "mClose/aCurrent", tr( "&Current" ), QIcon( ":/file/icons/file/close.png" ), tr( "Ctrl+W" ), tr( "Close the current file" ) ))->setEnabled( false );
		(kac->kernelActions.aFileCloseAll = mb->action( "mClose/aAll", tr( "&All" ), QIcon( ":/file/icons/file/closeall.png" ), QString::null, tr( "Close all files" ) ))->setEnabled( false );
		mb->action( "aSeparator3" );
		//axxxx = mb->action( "aSaveAsTemplate", tr( "Save As &Template" ), QIcon( ":/Icons/Icons/filesaveastemplate.png" ), tr( "Ctrl+T" ), tr( "Save the current file as template" ) )->setEnabled( false );
		mb->action( "aSeparator4" );
		(kac->kernelActions.aFileQuickPrint = mb->action( "aQuickPrint", tr( "Quic&k Print" ), QIcon( ":/file/icons/file/quickprint.png" ), QString::null, tr( "Quick print the current file" ) ))->setEnabled( false );
		(kac->kernelActions.aFilePrint = mb->action( "aPrint", tr( "&Print..." ), QIcon( ":/file/icons/file/print.png" ), tr( "Ctrl+P" ), tr( "Print the current file" ) ))->setEnabled( false );
		mb->action( "aSeparator5" );
		kac->kernelActions.aFileQuit = mb->action( "aQuit", tr( "&Quit" ), QIcon( ":/file/icons/file/quit.png" ), tr( "Ctrl+Q" ), tr( "Quit the application" ) );
	mb->endGroup();
	mb->menu( "mEdit", tr( "&Edit" ) );
	mb->beginGroup( "mEdit" );
		kac->kernelActions.aEditSettings = mb->action( "aSettings", tr( "Settings..." ), QIcon( ":/edit/icons/edit/settings.png" ) );
		kac->kernelActions.aEditShortcutsEditor = mb->action( "aShortcutsEditor", tr( "Shortcuts Editor..." ), QIcon( ":/edit/icons/edit/shortcuts.png" ), tr( "Ctrl+E" ), tr( "Edit the application shortcuts" ) );
		mb->action( "aSeparator1" );
		(kac->kernelActions.aEditUndo = mb->action( "aUndo", tr( "&Undo" ), QIcon( ":/edit/icons/edit/undo.png" ), tr( "Ctrl+Z" ), tr( "Undo" ) ))->setEnabled( false );
		(kac->kernelActions.aEditRedo = mb->action( "aRedo", tr( "&Redo" ), QIcon( ":/edit/icons/edit/redo.png" ), tr( "Ctrl+Y" ), tr( "Redo" ) ))->setEnabled( false );
		mb->action( "aSeparator2" );
		(kac->kernelActions.aEditCopy = mb->action( "aCopy", tr( "&Copy" ), QIcon( ":/edit/icons/edit/copy.png" ), tr( "Ctrl+C" ), tr( "Copy" ) ))->setEnabled( false );
		(kac->kernelActions.aEditCut = mb->action( "aCut", tr( "Cu&t" ), QIcon( ":/edit/icons/edit/cut.png" ), tr( "Ctrl+X" ), tr( "Cut" ) ))->setEnabled( false );
		(kac->kernelActions.aEditPaste = mb->action( "aPaste", tr( "&Paste" ), QIcon( ":/edit/icons/edit/paste.png" ), tr( "Ctrl+V" ), tr( "Paste" ) ))->setEnabled( false );
		mb->action( "aSeparator3" );
		(kac->kernelActions.aEditSearchReplace = mb->action( "aSearchReplace", tr( "&Search - Replace..." ), QIcon( ":/edit/icons/edit/search.png" ), tr( "Ctrl+F" ), tr( "Search - Replace..." ) ))->setEnabled( false );
		(kac->kernelActions.aEditSearchPrevious = mb->action( "aSearchPrevious", tr( "Search Previous" ), QIcon( ":/edit/icons/edit/search.png" ), tr( "Shift+F3" ), tr( "Search Previous" ) ))->setEnabled( false );
		(kac->kernelActions.aEditSearchNext = mb->action( "aSearchNext", tr( "Search Next" ), QIcon( ":/edit/icons/edit/search.png" ), tr( "F3" ), tr( "Search Next" ) ))->setEnabled( false );
		mb->action( "aSeparator4" );
		(kac->kernelActions.aEditGoTo = mb->action( "aGoTo", tr( "&Go To..." ), QIcon( ":/edit/icons/edit/goto.png" ), tr( "Ctrl+G" ), tr( "Go To..." ) ))->setEnabled( false );
		mb->action( "aSeparator5" );
		(kac->kernelActions.aEditExpandAbbreviation = mb->action( "aExpandAbbreviation", tr( "Expand Abbreviation" ), QIcon( ":/edit/icons/edit/abbreviation.png" ), tr( "Ctrl+L" ), tr( "Expand Abbreviation" ) ))->setEnabled( false );
	mb->endGroup();
	mb->menu( "mView", tr( "&View" ) );
	mb->beginGroup( "mView" );
		mb->menu( "mStyle", tr( "&Style" ), QIcon( ":/view/icons/view/style.png" ) );
		(kac->kernelActions.aViewNext = mb->action( "aNext", tr( "&Next Tab" ), QIcon( ":/view/icons/view/next.png" ), tr( "Alt+Right" ), tr( "Active the next tab" ) ))->setEnabled( false );
		(kac->kernelActions.aViewPrevious = mb->action( "aPrevious", tr( "&Previous Tab" ), QIcon( ":/view/icons/view/previous.png" ), tr( "Alt+Left" ), tr( "Active the previous tab" ) ))->setEnabled( false );
		//axxx = mb->action( "aFilteredView", tr( "&Filtered view" ), QIcon( "" ), tr( "" ), tr( "Filtered project view" ) )->setEnabled( false );	
	mb->endGroup();
	mb->menu( "mProject", tr( "&Project" ) );
	mb->beginGroup( "mProject" );
		kac->kernelActions.aProjectNew = mb->action( "aNew", tr( "&New" ), QIcon( ":/Icons/Icons/projectnew.png" ), tr( "Ctrl+Shift+N" ), tr( "New project..." ) );
		kac->kernelActions.aProjectOpen = mb->action( "aOpen", tr( "&Open" ), QIcon( ":/Icons/Icons/projectopen.png" ), tr( "Ctrl+Shift+O" ), tr( "Open a project..." ) );
		mb->menu( "mSave", tr( "&Save" ), QIcon( ":/Icons/Icons/projectsave.png" ) );
		kac->kernelActions.aProjectSaveCurrent = mb->action( "mSave/aCurrent", tr( "&Current" ), QIcon( ":/Icons/Icons/projectsave.png" ), QString::null, tr( "Save the current project" ) );
		kac->kernelActions.aProjectSaveAll = mb->action( "mSave/aAll", tr( "&All" ), QIcon( ":/Icons/Icons/projectsaveall.png" ), QString::null, tr( "Save all projects" ) );
		mb->menu( "mClose", tr( "&Close" ), QIcon( ":/Icons/Icons/projectclose.png" ) );
		kac->kernelActions.aProjectCloseCurrent = mb->action( "mClose/aCurrent", tr( "&Current" ), QIcon( ":/Icons/Icons/projectclose.png" ), QString::null, tr( "Close the current project" ) );
		kac->kernelActions.aProjectCloseAll = mb->action( "mClose/aAll", tr( "&All" ), QIcon( ":/Icons/Icons/projectcloseall.png" ), QString::null, tr( "Close all projects" ) );
		mb->action( "aSeparator2" );
		kac->kernelActions.aProjectSettings = mb->action( "aSettings", tr( "Set&tings..." ), QIcon( ":/Icons/Icons/projectsettings.png" ), QString::null, tr( "Project settings" ) );
		mb->action( "aSeparator3" );
		mb->menu( "mRecents", tr( "&Recents" ), QIcon( ":/Icons/Icons/recentsprojects.png" ) );
		kac->kernelActions.aProjectRecentsClear = mb->action( "mRecents/aClear", tr( "&Clear" ), QIcon( ":/Icons/Icons/filecloseall.png" ), QString::null, tr( "Clear the recents projects list" ) );
		mb->action( "mRecents/aSeparator1" );
	mb->endGroup();
...
/* Need to be plugin that instore its actions
	mb->beginGroup( "mBuild" );
		...
		axxx = mb->action( "mBuild/aCurrent", tr( "&Current" ), QIcon( ":/Icons/Icons/buildbuild.png" ), QString::null, tr( "Build current" ) );
		axxx = mb->action( "mBuild/aAll", tr( "&All" ), QIcon( ":/Icons/Icons/buildbuild.png" ), QString::null, tr( "Build all" ) );
		mb->menu( "mRebuild", tr( "&Rebuild" ), QIcon( ":/Icons/Icons/buildrebuild.png" ) );
		axxx = mb->action( "mRebuild/aCurrent", tr( "&Current" ), QIcon( ":/Icons/Icons/buildrebuild.png" ), QString::null, tr( "Rebuild current" ) );
		axxx = mb->action( "mRebuild/aAll", tr( "&All" ), QIcon( ":/Icons/Icons/buildrebuild.png" ), QString::null, tr( "Rebuild all" ) );
		mb->action( "aSeparator1" );
		axxx = mb->action( "aStop", tr( "&Stop" ), QIcon( ":/Icons/Icons/buildstop.png" ), QString::null, tr( "Stop current" ) );
		mb->action( "aSeparator2" );
		mb->menu( "mClean", tr( "&Clean" ), QIcon( ":/Icons/Icons/buildclean.png" ) );
		axxx = mb->action( "mClean/aCurrent", tr( "&Current" ), QIcon( ":/Icons/Icons/buildclean.png" ), QString::null, tr( "Clean current" ) );
		axxx = mb->action( "mClean/aAll", tr( "&All" ), QIcon( ":/Icons/Icons/buildclean.png" ), QString::null, tr( "Clean all" ) );
		mb->menu( "mDistClean", tr( "&Dist Clean" ), QIcon( ":/Icons/Icons/builddistclean.png" ) );
		axxx = mb->action( "mDistClean/aCurrent", tr( "&Current" ), QIcon( ":/Icons/Icons/builddistclean.png" ), QString::null, tr( "Dist clean current" ) );
		axxx = mb->action( "mDistClean/aAll", tr( "&All" ), QIcon( ":/Icons/Icons/builddistclean.png" ), QString::null, tr( "Dist clean all" ) );
		mb->action( "aSeparator3" );
		axxx = mb->action( "aExecute", tr( "&Execute" ), QIcon( ":/Icons/Icons/buildexecute.png" ), QString::null, tr( "Execute current" ) );
		axxx = mb->action( "aExecuteWithParameters", tr( "Execute with &parameters..." ), QIcon( ":/Icons/Icons/buildexecute.png" ), QString::null, tr( "Execute current with parameters..." ) );
		mb->action( "aSeparator4" );
		axxx = mb->action( "aBuildExecute", tr( "Build, Execu&te" ), QIcon( ":/Icons/Icons/buildmisc.png" ), QString::null, tr( "Build and execute current" ) );
		axxx = mb->action( "aDistCleanBuildExecute", tr( "Dist Clean, Build, E&xecute" ), QIcon( ":/Icons/Icons/buildmisc.png" ), QString::null, tr( "Dist clean, build and execute current" ) );
	mb->endGroup();
*/
	mb->menu( "mTools", tr( "&Tools" ) );
	mb->beginGroup( "mTools" );
		kac->kernelActions.aToolsEdit = mb->action( "aEdit", tr( "&Edit..." ), QIcon( ":/Icons/Icons/toolsedit.png" ), QString::null, tr( "Edit tools..." ) );
		mb->action( "aSeparator1" );
	mb->endGroup();
	mb->menu( "mPlugins", tr( "Plu&gins" ) );
	mb->beginGroup( "mPlugins" );
		kac->kernelActions.aPluginsManage = mb->action( "aManage", tr( "&Manage..." ), QIcon( ":/Icons/Icons/toolsedit.png" ), QString::null, tr( "Manage plugins..." ) );
		mb->action( "aSeparator1" );
	mb->endGroup();
	mb->menu( "mHelp", tr( "&Help" ) );
	mb->beginGroup( "mHelp" );
		kac->kernelActions.aHelpManual = mb->action( "aManual", tr( "&Manual" ), QIcon( ":/help/icons/help/assistant.png" ), QString::null, tr( "Manual" ) );
		mb->action( "aSeparator1" );
		kac->kernelActions.aHelpAbout = mb->action( "aAbout", tr( "&About..." ), QIcon( ":/application/icons/application/monkey2.png" ), QString::null, tr( "About application..." ) );
		kac->kernelActions.aHelpAboutQt = mb->action( "aAboutQt", tr( "About &Qt..." ), QIcon( ":/help/icons/help/qt.png" ), QString::null, tr( "About Qt..." ) );
#ifdef __COVERAGESCANNER__
		kac->kernelActions.aHelpTestReport = mb->action( "aTestReport", tr( "&Test Report" ), QIcon( ) , tr( "Pause" ), tr( "Coverage Meter Test Report..." ) );
#endif
	mb->endGroup();
