...
void UIMain::initMenuBar()
{
	...
	mb->beginGroup( "mWindow" );
		mb->action( "aSDI", tr( "&Single document mode" ), QIcon( "" ), QString::null, tr( "Single document mode" ) );
		mb->action( "aMDI", tr( "&Multidocument mode" ), QIcon( "" ), QString::null, tr( "Multidocument mode" ) );
        mb->action( "aTopLevel", tr( "&Top level windows" ), QIcon( "" ), QString::null, tr( "Top level windows" ) );
		mb->action( "aSeparator1" );
