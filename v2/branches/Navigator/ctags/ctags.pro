...
CONFIG	-= qt
DESTDIR	= $${BUILD_PATH}
win32-msvc*:DEFINES	*= WIN32 HAVE_REGCOMP REGEX_MALLOC STDC_HEADERS=1 _CRT_SECURE_NO_DEPRECATE
...
CONFIG(DebugBuild)|CONFIG(debug, debug|release) {
	...
	unix:OBJECTS_DIR	= $${BUILD_PATH}/debug/.obj/unix/ctags
	win32:OBJECTS_DIR	= $${BUILD_PATH}/debug/.obj/win32/ctags
	mac:OBJECTS_DIR	= $${BUILD_PATH}/debug/.obj/mac/ctags
	UI_DIR	= $${BUILD_PATH}/debug/.ui
	MOC_DIR	= $${BUILD_PATH}/debug/.moc
	RCC_DIR	= $${BUILD_PATH}/debug/.rcc
} else {
	#Release
	unix:OBJECTS_DIR	= $${BUILD_PATH}/release/.obj/unix/ctags
	win32:OBJECTS_DIR	= $${BUILD_PATH}/release/.obj/win32/ctags
	mac:OBJECTS_DIR	= $${BUILD_PATH}/release/.obj/mac/ctags
...
mac:SOURCES	*= $${CTAGS_PATH}/mac.c

SOURCES	+= src/exuberantCtags.c
