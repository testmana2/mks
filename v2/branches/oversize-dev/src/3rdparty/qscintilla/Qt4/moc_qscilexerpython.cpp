...
**
** Created: Thu Oct 26 22:14:45 2006
...
static const char qt_meta_stringdata_QsciLexerPython[] = {
    "QsciLexerPython\0\0fold\0setFoldComments(bool)\0setFoldQuotes(bool)\0"
    "warn\0setIndentationWarning(IndentationWarning)\0"
};
...
int QsciLexerPython::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: setIndentationWarning((*reinterpret_cast< IndentationWarning(*)>(_a[1]))); break;
        }
        _id -= 3;
    }
    return _id;
