...
public:
	Parse (const QString &CtagsCmdPath, const QString &TagsFilePath, const QString &SourceFilePath, const QString &SmallTagsFilePath ) : ctagsCmdPath(CtagsCmdPath), tagsFilePath(TagsFilePath), sourceFilePath(SourceFilePath), smallTagsFilePath(SmallTagsFilePath) {};
	...
	*/
	Expression parseExpression(QString expr, Scope * scope);
	...
	* localdef = "int"
	*/
	void getScopeAndLocals(Scope * sc, const QString &expr, const QString &ident);
