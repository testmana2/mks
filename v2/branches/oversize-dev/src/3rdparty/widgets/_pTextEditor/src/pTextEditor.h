...
public:
	...
	bool open( const QString& = QString::null, QTextCodec* = 0 );
	bool save( bool = false, QTextCodec* = 0 );
...
private:
	...
	//
public slots:
	void openFile( const QString& = QString::null, QTextCodec* = 0 );
	void saveFile( bool = false, QTextCodec* = 0 );
