...
This is pTextEditor v0.6.0
=========================

Compil
======

qmake && make, run pTextEditorDemo to see a demo of the widget
...
Add an entry to your linker : -lpTextEditorPlugin

Example
=======

if the dir pTextEditor is at : /home/login/pTextEditor
and if you don't want to copy files then your pro file must be like this

INCLUDEPATH += /home/login/pTextEditor/plugin/src
LIBS += -lpTextEditorPlugin -L/home/login/pTextEditor
