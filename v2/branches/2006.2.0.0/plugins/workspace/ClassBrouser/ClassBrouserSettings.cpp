...
ClassBrouserSettings::ClassBrouserSettings (ClassBrouser* tcb, int projectMask, int fileMask)
{
	classBrouser = tcb;
...
ClassBrouserSettings::~ClassBrouserSettings ()
{
	
}

void ClassBrouserSettings::setSettings()
{
	int projectMask = 0;
	int fileMask = 0;
	for (int i = 0; i < typesCount; i++)
