...
struct GNUDebuggerPluginStruct
{
...
class GNUDebuggerPluginInterface
{
public:
	GNUDebuggerPluginInterface()
	{
		qslGetEr_Gdb = QStringList() << PLUGIN_ER_GDB;
	}

	virtual ~GNUDebuggerPluginInterface() {}
	...
	virtual int pluginDataFromGdb(struct GNUDebuggerPluginStruct * debugger_struct)= 0;
...
signals:
	virtual void signalPluginAction(GNUDebuggerPluginInterface * ,struct GNUDebuggerPluginStruct *debugger_struct)=0;
	virtual void signalPluginMouse(QMouseEvent *)=0;
};
 


Q_DECLARE_INTERFACE(GNUDebuggerPluginInterface, "plugin.GNUDebuggerPluginInterface/1.0")
