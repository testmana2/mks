...
void ProjectItem::reBuild()
{
	clean();
	build();
}

void ProjectItem::distClean()
{
	//exec executeCommand
}

void ProjectItem::execute()
{
	//exec executeCommand
}

void ProjectItem::buildExecute()
{
	build();
	execute();
}

void ProjectItem::addActionsToMenu()
{
		UIMain* uiMain = UIMain::instance();
			
		uiMain->buildActions.build->setEnabled (!buildCommand.isNull());
		connect (uiMain->buildActions.build, SIGNAL(triggered()), this, SLOT(build()));
		
		uiMain->buildActions.clean->setEnabled (!cleanCommand.isNull());
		connect (uiMain->buildActions.clean, SIGNAL(triggered()), this, SLOT(clean()));
		
		uiMain->buildActions.reBuild->setEnabled (!buildCommand.isNull() && !cleanCommand.isNull());
		connect (uiMain->buildActions.reBuild, SIGNAL(triggered()), this, SLOT(reBuild()));
		
		uiMain->buildActions.distClean->setEnabled (!distCleanCommand.isNull());
		connect (uiMain->buildActions.distClean, SIGNAL(triggered()), this, SLOT(distClean()));
		
		uiMain->buildActions.execute->setEnabled (!executeCommand.isNull());
		connect (uiMain->buildActions.execute, SIGNAL(triggered()), this, SLOT(execute()));
		
		uiMain->buildActions.buildExecute->setEnabled (!buildCommand.isNull() &&  !executeCommand.isNull());
		connect (uiMain->buildActions.buildExecute, SIGNAL(triggered()), this, SLOT(buildExecute()));
}

void ProjectItem::removeActionsFromMenu()
{
		UIMain* uiMain = UIMain::instance();
			
		disconnect (uiMain->buildActions.build, SIGNAL(triggered()), this, SLOT(build()));
		disconnect (uiMain->buildActions.clean, SIGNAL(triggered()), this, SLOT(clean()));
		disconnect (uiMain->buildActions.reBuild, SIGNAL(triggered()), this, SLOT(reBuild()));
		disconnect (uiMain->buildActions.distClean, SIGNAL(triggered()), this, SLOT(distClean()));
		disconnect (uiMain->buildActions.execute, SIGNAL(triggered()), this, SLOT(execute()));
}
